...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        title='Total success launches in all site')
        return fig
    else:
        ...
        fig=px.pie(df_site, names='class', values ='class count', title = 'Success Launch by Selected Site')
        return fig
...
def get_scatter_chart(entered_site,payload_value):    
    ...
    # filtered_df2_1=spacex_df[(spacex_df['Payload Mass (kg)'] > payload_range[0]) & (spacex_df['Payload Mass (kg)'] < payload_range[1])]
